...
const About = () => {
  return (
    <div className="theme-light bg-background text-foreground">
      {/* Hero — Lite Filter applied to original image */}
      <section className="relative py-32 md:py-44 overflow-hidden">
        <div className="absolute inset-0">
          <img 
            src={aboutBg} 
            className="w-full h-full object-cover" 
            alt="About SS Gold Hub" 
            loading="eager" 
          />
          {/* Lite black filter to help text contrast */}
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6">
          <AnimatedSection>
            <div className="max-w-3xl">
              <span className="label-gold mb-6 block w-fit">About Us</span>
              {/* Changed text to white to contrast against the lite dark filter */}

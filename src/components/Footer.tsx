...
import { Facebook, Instagram, Linkedin, ArrowUp, Phone, Mail, MapPin, Clock, Heart } from "lucide-react";
    ...
    <footer className="bg-card border-t border-primary/10">
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-sm font-sans font-semibold tracking-wider uppercase text-primary mb-6">Quick Links</h4>
          ...
          {/* Services */}
          <div>
            <h4 className="text-sm font-sans font-semibold tracking-wider uppercase text-primary mb-6">Services</h4>
            <ul className="space-y-3">
          ...
          {/* Contact */}
          <div>
            <h4 className="text-sm font-sans font-semibold tracking-wider uppercase text-primary mb-6">Contact Info</h4>
        ...
        <div className="mt-16 pt-8 border-t border-primary/10 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex justify-center items-center gap-1 text-xs text-muted-foreground">
            ...
            >
              <img src="/staffarclogo.jpg" alt="StaffArc logo" className="h-4 w-4 object-contain" />
              StaffArc
            </a>
          </div>
      ...
      <button
        onClick={scrollToTop}
        className="fixed bottom-8 right-8 w-12 h-12 bg-primary text-primary-foreground rounded-lg flex items-center justify-center z-40 hover:bg-accent transition-colors animate-gold-pulse"
